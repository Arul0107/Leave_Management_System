...
<head>
	...
	<!-- Site favicon -->
	<link rel="icon" sizes="180x180" href="vendors/images/ESEC_Logo.webp">
	<link rel="icon" type="image/png" sizes="32x32" href="vendors/images/ESEC_Logo.webp">
	<link rel="icon" type="image/png" sizes="16x16" href="vendors/images/ESEC_Logo.webp">
	...
	<div class="login-header box-shadow">
		<div class="container-fluid d-flex justify-content-between align-items-center">
			<div class="brand-logo">
				<a href="login.html">
					<img src="vendors/images/ESEC_Logo.webp" alt="" width="70px">
				</a>
			</div>
		</div>
	</div>
